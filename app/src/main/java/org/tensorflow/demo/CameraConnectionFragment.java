...
public class CameraConnectionFragment extends Fragment implements Interface_SetImage {
    ...
    private final TensorFlowImageListener tfPreviewListener = new TensorFlowImageListener(this);
    ...
    public ImageView mAugmentedImageView;
    ...
    public View onCreateView(
        ...
        if (getActivity() != null) {
            if (getActivity() instanceof CameraActivity) {
                mContext = (CameraActivity) getActivity();
            }
        }
    ...
    public void onViewCreated(final View view, final Bundle savedInstanceState) {
        ...
        mAugmentedImageView = (ImageView) view.findViewById(R.id.augmented_object_imageview);
    }
    ...
    @Override
    public void setImage(final String title) {
        getActivity().runOnUiThread(new Runnable() {
            @Override
            public void run() {
                setAugmentedImage(title);

            }
        });
    }

    private void setAugmentedImage(String title) {

        switch (title) {
            case "notebook":
                mAugmentedImageView.setVisibility(View.VISIBLE);
                mAugmentedImageView.setImageDrawable(getActivity().getResources().getDrawable(R.drawable.laptop_circuit_board));
                break;
            case "laptop":
                mAugmentedImageView.setVisibility(View.VISIBLE);
                mAugmentedImageView.setImageDrawable(getActivity().getResources().getDrawable(R.drawable.laptop_circuit_board));
            default:
                mAugmentedImageView.setVisibility(View.INVISIBLE);
        }
